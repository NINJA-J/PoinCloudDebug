...
pcl::PointCloud<pcl::PointXYZ>::Ptr myBoxFilter(pcl::PointCloud<pcl::PointXYZ>::Ptr &input, double xMin, double xMax, double yMin, double yMax, double zMin, double zMax);
